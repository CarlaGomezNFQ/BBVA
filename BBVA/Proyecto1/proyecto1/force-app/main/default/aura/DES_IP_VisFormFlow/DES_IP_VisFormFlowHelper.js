  ...
  selectOperation : function(component, operation, url, http) {
   ...
   var externalId = component.get('v.codForm');
    ...
    if (operation === 'alta') {
      ...
      url = url + $A.get("$Label.c.DES_IP_URL_VISIT") + codVisit+ $A.get("$Label.c.DES_IP_URL_OPP_FORM") ;
      try {
      ...
      url = url + $A.get("$Label.c.DES_IP_URL_VISIT") + codVisit+ $A.get("$Label.c.DES_IP_URL_OPP_FORM") + externalId;
